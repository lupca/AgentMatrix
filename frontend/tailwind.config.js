  ...
  theme: {
    extend: {
      colors: {
        ...
        indigo: Object.fromEntries([400, 500, 600, 700, 800, 950].map((shade) => [shade, `rgb(var(--color-indigo-${shade}) / <alpha-value>)`])),
        ...
        emerald: Object.fromEntries([300, 400, 500].map((shade) => [shade, `rgb(var(--color-emerald-${shade}) / <alpha-value>)`])),
