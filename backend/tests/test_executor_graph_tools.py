...
async def test_executor_graph_tool_persists_metric_to_db(executor_db, monkeypatch):
    ...
    # Lá chắn ở tool_metrics.record_tool_metric bỏ qua mọi ghi khi TESTING=1.
    # Test NÀY cần đường ghi chạy thật, nên tắt lá chắn — nhưng CHỈ trong test
    # này, và chỉ khi executor_db đã trỏ SessionLocal sang SQLite tạm. Tắt ở
    # fixture dùng chung sẽ mở lá chắn cho cả module và từng ghi rác vào DB
    # production (CTV2-1358, dòng tool_metrics task_id='task-graph-1').
