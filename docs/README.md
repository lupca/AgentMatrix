...
1. **`spec/`** — đặc tả hệ thống, LUÔN phản ánh hiện trạng code (cập nhật khi đổi hành vi):
   ...
   - `08-living-spec.md` — **THIẾT KẾ, chưa triển khai**: hệ spec sống —
     spec/ADR thành dữ liệu có neo vào code, tự gắn cờ khi lỗi thời, phát hiện
     trùng/xung đột; kèm bản thiết kế thực thi (impl_design) chốt trước dispatch
